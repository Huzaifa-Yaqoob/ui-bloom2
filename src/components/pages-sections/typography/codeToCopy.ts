export const tsxCode = `import { Slot } from '@radix-ui/react-slot';
...
export const jsxCode = `import { Slot } from '@radix-ui/react-slot';
import { memo } from 'react';
import { cn } from '@/lib/utils';

function H1Component({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'h1';
  return (
    <Comp
      className={cn(
...
function H2Component({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'h2';
  return (
    <Comp
      className={cn(
...
function H3Component({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'h3';
  return (
    <Comp
      className={cn(
...
function H4Component({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'h4';
  return (
    <Comp
      className={cn(
...
function H5Component({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'h5';
  return (
    <Comp
      className={cn(
...
function H6Component({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'h6';
  return (
    <Comp
      className={cn(
...
function PComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'p';
  return (
    <Comp
      className={cn('text-sm leading-6 sm:text-base md:leading-7', className)}
...
function BlockQuoteComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'blockquote';
  return (
    <Comp
      className={cn(
...
function CodeComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'code';
  return (
    <Comp
      className={cn(
...
function LeadComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp
      className={cn(
...
function LargeComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp
      className={cn('text-base font-semibold sm:text-lg md:text-xl', className)}
...
function SmallComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp
      className={cn('text-xs leading-none font-medium sm:text-sm', className)}
...
function MutedComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp
      className={cn('text-muted-foreground text-xs sm:text-sm', className)}
...
function TitleComponent({ asChild = false, children, className, ...props }) {
  const Comp = asChild ? Slot : 'div';
  return (
    <Comp
      className={cn(
