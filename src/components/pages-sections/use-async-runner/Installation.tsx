...
import ManualInstallation from '@/components/pages-sections/use-async-runner/ManualInstallation';
...
function Installation() {
  return (
    <Section id={'typography-installation'}>
      <H2>Installation</H2>
      <Installationtab
        cliChildren={<CliInstallation componentName={'use-async-runner'} />}
